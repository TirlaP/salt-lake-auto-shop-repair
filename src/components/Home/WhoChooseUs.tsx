   ...
   return (
      <section className="overflow-hidden bg-[#12151B] bg-[url('/images/bg-1.svg')] bg-cover">
         ...
         >
            ...
            >
               <FanFactCard footnote="vehicles repaired" title="15K+" />
            </MotionDiv>
            <MotionDiv
               variants={{
                  offscreen: { opacity: 0, x: 200 },
            ...
            >
               <FanFactCard footnote="years experience" title="60+" />
            </MotionDiv>
            <MotionDiv
               variants={{
                  offscreen: { opacity: 0, x: -200 },
            ...
            >
               <FanFactCard footnote="happy customers" title="98%" />
            </MotionDiv>
            <MotionDiv
               variants={{
                  offscreen: { opacity: 0, x: 200 },
            ...
            >
               <FanFactCard footnote="services completed" title="8K+" />
            </MotionDiv>
         </MotionDiv>
      </section>
   );
